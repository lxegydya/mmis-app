...
// @ts-nocheck
	...
	let getAssignments = () => {
		ApiController({
			method:"POST",
			endpoint:`assignments/mentor/program/${data.params.slug}`,
			datas: {
			...
			<div class="container-xxl flex-grow-1 container-p-y">
				<h4 class="fw-bold py-3 mb-4">
					...
					<span
						...
						on:click={() => {
							window.location.href = '/mentor/scoring'
						}}
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="data-{a.id}" 
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-sm btn-outline-primary" on:click={() => window.location.href = `/mentor/scoring/list/appraise/${a.id}`}>Appraise</button>
                                            </td>
                                        </tr>
                                        {/each}
                                    </tbody>
