...
// @ts-nocheck
    ...
    let resetPassword = () => {
        if(jquery('#old-password').val() == ''){
            return swal({
				title: "Oops, you forgot something!",
				text: "Please insert Old Password!",
				icon: "error",
				button: {
                    text : 'Okay!',
                    value : true,
        ...
        ApiController({
            method : "POST",
            endpoint : `mentor/${Cookie.get('token')}/password/reset`,
            datas : {
                role : Cookie.get('role'),
                password : jquery('#old-password').val(),
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4">
					...
					<span
						...
						on:mouseover={() => jquery('#nav-back-link').css('cursor', 'pointer')}>Account Settings /</span
					> Reset Password
				</h4>
                <div class="row">
                    <div class="col-md-6">
